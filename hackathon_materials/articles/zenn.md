...
emoji: "🏷️"
type: "tech"
topics: ["claude", "llm", "aiagent", "python", "hackathon"]
published: false
---
...
5. 次の選択肢：**共有**（オーナーが決めたフォルダへコピー）／**送信の準備**（Gmail の作成画面を開く。自分の Gmail アドレスを設定すると、宛先に入る。送るのは人）
...
- 自動テスト 853 件。門を1つずつ外すと、テストが失敗することを 35 か所で確認。
